...
-- ============================================================================
-- Usuario MySQL: u616221621_figoti
-- Password: Taroti2026!
-- Base de datos: u616221621_figoti (ya existe)
...
SELECT 'Tablas creadas exitosamente para Hostinger ✅' AS resultado;
...
WHERE TABLE_SCHEMA = 'u616221621_figoti'
ORDER BY TABLE_NAME;
